...
TRAIN_MODEL_PATH = "distilbert/distilbert-base-uncased"
...
args = TrainingArguments(
    output_dir='kaggle/output/distilbert',
    learning_rate=2e-5,
    num_train_epochs=3,
...
# trainer.save_model(PATH+"BertlargeNERbase")
# tokenizer.save_pretrained(PATH+"BertlargeNERbase")

# model_path = PATH + "BertlargeNERbase_downsampling"
...
if hasattr(trainer, 'state') and hasattr(trainer.state, 'log_history'):
    with open(PATH + 'training_logs_distilbert_downsampling.json', 'w') as f:
        json.dump(trainer.state.log_history, f)

trainer.save_model(PATH+"Distilbert_downsampling")
tokenizer.save_pretrained(PATH+"Distilbert_downsampling")
