...
if hasattr(trainer, 'state') and hasattr(trainer.state, 'log_history'):
    with open(PATH + 'training_logs.json', 'w') as f:
        json.dump(trainer.state.log_history, f)

trainer.save_model(PATH+"BertlargeNERbase_downsampling")
tokenizer.save_pretrained(PATH+"BertlargeNERbase_downsampling")
